...
const AlumniPortal = () => {
  ...
  const onNeedAnAccountClick = useCallback(() => {
    // Please sync "Alumni Sign up (from student email)" to the project
  }, []);
  ...
  return (
    <div className="relative bg-white w-full h-[832px] overflow-hidden text-left text-3xl text-darkgray font-sen">
      ...
      />
      <div className="absolute top-[25px] left-[calc(50%_+_173px)] text-25xl font-semibold font-poppins text-darkslateblue inline-block w-[219px] h-[39px]">
        Log In
      </div>
      <img
