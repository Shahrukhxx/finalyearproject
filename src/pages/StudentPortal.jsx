...
const StudentPortal = () => {
  ...
  const onRectangleClick = useCallback(() => {
    // Please sync "Cretae Profile" to the project
  }, []);
  ...
  const onRectangle8Click = useCallback(() => {
    // Please sync "Create Profile" to the project
  }, []);
    ...
    <div className="relative bg-white w-full h-[832px] text-left text-3xl text-darkgray font-sen">
      ...
      <div className="absolute top-[448px] left-[671px] w-[422px] h-[53px]">
        ...
        <div className="absolute h-2/5 w-[28.06%] top-[30%] left-[8.06%] inline-block">
          ...
          {/* <input
          className="absolute h-2/5 w-[28.06%] top-[30%] left-[8.06%] inline-block"
            type="text"
            id="myInput"
            value={inputValue}
      ...
      />
      <div className="absolute top-[25px] left-[calc(50%_+_173px)] text-[44px] font-semibold font-poppins text-darkslateblue inline-block w-[219px] h-[39px]">
        Log In
      </div>
      <img
      ...
      />
      <b className="absolute top-[654px] left-[790px] text-[24px] flex text-whitesmoke-100 text-center items-center justify-center w-[185px] h-[27px]">
        Log In
      </b>
      <img
